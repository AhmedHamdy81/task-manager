...
class ProducerHuntWaveTests(unittest.TestCase):
    def test_studio_01_wave_data(self):
        ...
        self.assertIn('id: "wave_01"', level)
        self.assertIn('id: "wave_02"', level)
        self.assertIn('id: "wave_03"', level)
        self.assertIn('id: "final_wave"', level)
        self.assertIn("healthMultiplier: 2", level)
        self.assertIn("speedMultiplier: 1.15", level)
        self.assertIn("damageMultiplier: 1.25", level)
        self.assertIn("elite: true", level)
